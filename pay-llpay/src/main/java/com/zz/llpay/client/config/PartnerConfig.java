package com.zz.llpay.client.config;
...
public interface PartnerConfig{
    ...
    // 接收异步通知地址
    String NOTIFY_URL     = "http://zzhang.free.idcfengye.com/notify";
    // 支付结束后返回地址
    String URL_RETURN     = "http://zzhang.free.idcfengye.com/urlReturn.jsp";
    // 商户编号
